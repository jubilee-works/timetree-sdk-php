...
use TimeTreeWebApi\OauthApp\Parameter\CreateActivityParams as ParameterCreateActivityParams;
...
$event = $instance->createActivity(new ParameterCreateActivityParams($getOpt["calendarId"], $getOpt["eventId"], "test comment"));
